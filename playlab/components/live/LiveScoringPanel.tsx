...
import { useLiveScoring } from "@/store/live-scoring-store";
import { completeRunAction, submitReviewAction, type LiveEventInput } from "@/lib/actions";
import type { DrillView } from "@/types";
import { FlowBadge, StatusPill } from "@/components/ui";
      ...
      <div className="mx-auto max-w-xl">
        <div className="glass p-6 text-center">
          ...
          <div className="mt-5 flex justify-center gap-2">
            <Link href={`/sessions/${sessionId}`} className="btn-primary" onClick={() => live.reset()}>
              Back to session
            </Link>
            <Link href="/leaderboard" className="btn-ghost" onClick={() => live.reset()}>
              View leaderboard
            </Link>
          </div>
        </div>
