        ...
        {ordered.map((item, i) => (
          ...
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <Link href={`/drills/${item.drill.id}/edit?sessionId=${context.id}`} className="rounded-lg border border-line p-1.5 text-cream/70 hover:border-blue/60 hover:text-cream">
                <Pencil size={14} />
              </Link>
