...
import { validateDrill } from "@/playlab/lib/rule-engine";
import { calculateFlow } from "@/playlab/lib/player-flow";
import { scoreEvents } from "@/playlab/lib/scoring-engine";
import { computeXP, xpGuardrails } from "@/playlab/lib/xp-engine";
import { saveDrillAction } from "@/playlab/lib/actions";
import { FlowBadge, IssueBadge, StatusPill } from "@/playlab/components/ui";
import type {
  DrillConstraints,
  DrillRule,
  DrillView,
    ...
    <div className="mx-auto max-w-[1500px]">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Link
            href={sessionId ? `/playlab/sessions/${sessionId}` : `/playlab/drills/${drill.id}`}
