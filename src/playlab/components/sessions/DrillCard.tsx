...
import { DrillTag, EngagementMechanicPill, FlowBadge, StatusPill } from "@/playlab/components/ui";
import { remixDrillAction, removeSessionDrillAction } from "@/playlab/lib/actions";
  ...
  return (
    <div className="glass p-5">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Link
          href={`/playlab/drills/${d.id}/edit?sessionId=${sessionId}`}
