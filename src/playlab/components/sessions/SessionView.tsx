...
import type { DrillMetrics, DrillView, SessionContext } from "@/playlab/types";
import type { SessionBalance } from "@/playlab/lib/session-analysis";
import { StatusPill } from "@/playlab/components/ui";
import { DrillCard } from "./DrillCard";
import { SessionBalancePanel } from "./SessionBalancePanel";
import { SessionTimeline } from "./SessionTimeline";
import { remixDrillAction } from "@/playlab/lib/actions";
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        <Link href={`/playlab/drills?sessionId=${context.id}`} className="btn-ghost">
          <Plus size={15} /> Add from library
        </Link>
        <Link href={`/playlab/drills/new?sessionId=${context.id}`} className="btn-primary">
